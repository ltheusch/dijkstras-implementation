...
public class GraphTest {
    ...
    /**
     *Checks the total weight from A to E
     */
    @Test
    ...
    /**
     * Checks the total cost from E to F
     */
    @Test
    ...
    /**
     * Tests the predecessor to end node E is correct
     */
    @Test
    public void testPredecessorToE(){
        assertTrue(graph.shortestPath("C","E").get(1).equals("B"));
        assertTrue(graph.shortestPath("C", "E").toString().equals("[C, B, E]"));
    }

    /**
     * Tests both the total cost and the ordered sequence from D to F
     */
    @Test
    public void testDtoEALL(){
        assertTrue(graph.shortestPath("D", "F").toString().equals("[D, E, A, C, F]"));
        assertTrue(graph.getPathCost("D", "F") == 10);
    }
